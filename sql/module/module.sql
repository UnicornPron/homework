...
CREATE TABLE public.persons (
    id integer NOT NULL,
    name character varying(40) DEFAULT 'None'::character varying NOT NULL,
    pwd character varying(100) DEFAULT 'None'::character varying NOT NULL,
    email character varying(100) DEFAULT 'None'::character varying NOT NULL,
    gender character varying(10) DEFAULT 'None'::character varying NOT NULL
);
...
COPY public.persons (id, name, pwd, email, gender) FROM stdin;
